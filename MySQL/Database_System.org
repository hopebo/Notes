...
We have two approaches to organize the datas inside the page:
- Tuple-oriented
- Log-structured

**** 3.5.2.1 Slotted Pages
...
**** 3.5.2.2 Log-structured File Organization
Instead of storing tuples in pages, the DBMS only stores log records.

The system appends log records to the file of how the database was modified:
- Insert stores the entire tuple.
- Delete marks the tuple as deleted.
- Update contains the delta of just the attributes that were modified.
...
It's the job of DBMS to interpret those bytes into attribute types and values.
...
**** 3.5.3.1 Denormalized Tuple Data
